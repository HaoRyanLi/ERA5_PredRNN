...
dataset_path = '/scratch/09012/haoli1/ERA5/dataset_6hrs/'
infile = sys.argv[1]
...
for curr_year in years:
    ...
    file_name = 'era5_train_'+str(curr_year)+'_3_24hr.npz'
    if shift != 0:
        file_name = file_name[:-4] + '_shift' + str(shift) + '.npz'

    np.savez(dataset_path+file_name, **final_ds)